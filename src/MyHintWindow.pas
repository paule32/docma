...
begin
  ...
  FRectTitle.Width  := Canvas.TextWidth (AHint);
  FRectTitle.Height := Canvas.TextHeight(AHint);
...
begin
  ...
  FRectDescription.Width  := Canvas.TextWidth (AHint);
  FRectDescription.Height := Canvas.TextHeight(AHint);
...
begin
  ...
  Width  := rectD.Width                 + 24;
  Height := rectD.Height + rectT.Height + 24;
